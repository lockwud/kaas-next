    ...
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl px-6 py-8 text-center">
        ...
        <div className="flex gap-3">
          <button
            type="button"
            className="flex-2 whitespace-nowrap border-2 border-green-700 text-green-700 rounded-full py-2 text-sm font-semibold transition hover:bg-green-700 hover:text-white"
          >
          ...
          <button
            type="submit"
            className="flex-1 whitespace-nowrap flex items-center justify-center gap-1 bg-yellow-400 text-green-900 rounded-full py-2 text-sm font-bold transition hover:bg-yellow-500"
          >
