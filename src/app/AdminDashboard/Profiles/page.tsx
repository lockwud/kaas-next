...
export default function ProfilesPage() {
    ...
    // Profile State
    const [fullName, setFullName] = React.useState("Kwame Mensah");
    const [email, setEmail] = React.useState("k.mensah@isghana.edu");
    const [phone, setPhone] = React.useState("+233 24 123 4567");
    const [address, setAddress] = React.useState("No. 12 East Legon, Accra");
                ...
                <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <div className="relative inline-block">
                            ...
                            <button className="absolute bottom-1 right-1 h-8 w-8 rounded-full bg-emerald-600 text-white flex items-center justify-center border-2 border-white shadow-lg hover:bg-emerald-700 transition-colors">
                                <Camera size={16} />
                            </button>
                        </div>
                        <h1 className="text-3xl font-black text-slate-900 mt-4 tracking-tight">{fullName}</h1>
                        <p className="text-[10px] font-black text-emerald-600 uppercase tracking-[0.2em] mt-1 bg-emerald-50 px-3 py-1 rounded-full inline-block">Super Administrator</p>
                        <p className="text-xs text-slate-400 mt-2 font-medium italic">School ID: ISG-ADMIN-001</p>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4 backdrop-blur-sm">
                        ...
                        >
                            <div className="flex items-center justify-between border-b border-slate-200 bg-slate-50 px-6 py-4">
                                ...
                                <button onClick={() => setIsEditModalOpen(false)} className="rounded-full p-1.5 text-slate-500 hover:bg-slate-200 transition-colors"><X size={18} /></button>
                            </div>
