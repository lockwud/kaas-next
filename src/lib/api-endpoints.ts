...
export const API_ENDPOINTS = {
  ...
  attendance: normalize(process.env.NEXT_PUBLIC_API_ENDPOINT_ATTENDANCE ?? "/attendance"),
  vacationDates: normalize(process.env.NEXT_PUBLIC_API_ENDPOINT_VACATION_DATES ?? "/attendance/vacation-date"),
  reopeningDates: normalize(process.env.NEXT_PUBLIC_API_ENDPOINT_REOPENING_DATES ?? "/attendance/reopening-date"),
